...
tweet_detail_db = '__HOME__/twitter/twitter.db'  

auth = tweepy.OAuthHandler(secrets.twitter_API_key, secrets.twitter_API_secret_key)
auth.set_access_token(secrets.twitter_Access_token, secrets.twitter_Access_secret_token)
...
gmaps = googlemaps.Client(key=secrets.Google_API_KEY)
